...
$profileSocials=array_filter([
    'facebook'=>$contactLinks['facebook']??'https://www.facebook.com/share/1CovpVL5Yy/',
    'github'=>$contactLinks['github']??'https://github.com/aimievillabeto-dragon',
...
<section class="site-width py-16 achievements-theme-showcase">
  <div class="theme-album-header">
    ...
    <!-- 3 Pillars Gallery matching the reference design -->
    <div class="theme-pillars-grid">

      <!-- Column 01 (Terracotta Peach) -->
